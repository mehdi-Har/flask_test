...
from services.user_service import DoctorService
from models.user import Doctor, Specialite

doctors_bp = Blueprint("doctors", __name__)  # Correction: __name__ au lieu de **name**
